...
public class PictureController {
    ...
    public @ResponseBody boolean updatePicture(Picture picture) {
        try {
    ...
    public @ResponseBody boolean deletePicture(int id) {
        try {
    ...
    public @ResponseBody boolean addPicture(Picture picture, MultipartFile myjar, HttpServletRequest request) {
        try {
            String fileName = myjar.getOriginalFilename();
            fileName = new Date().getTime() + "_" + fileName;
            String realPath = request.getRealPath("/shouye/");

            String imgPath = "/shouye/" + fileName;
