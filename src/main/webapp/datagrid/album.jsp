            ...
            handler: function () {
                ...
                if (row == null) {
                    ...
                    if (row.score != null) {
                        ...
                        $("#album_img").prop("src", "${pageContext.request.contextPath}/audioCollection/"+row.coverImg);
                        $('#album').dialog("open");
                    } else {
                        $.messager.alert("提示框", "请先选中专辑", "info");
                    }
...
<div id="addalbum">
    <form id="addalbumForm" method="post" enctype="multipart/form-data">
        ...
        背景图片<div class="lf salebd"><a href="#"><img src="images/<>.jpg" width="100" height="100"/></a></div>
